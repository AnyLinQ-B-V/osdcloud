...
if ($WindowsPhase -eq 'WinPE') {
    ...
    Start-OSDCloud -OSVersion 'Windows 11' -OSBuild 22H2 -OSEdition Enterprise -OSActivation Volume -OSLanguage nl-nl -SkipAutopilot -SkipODT -ScreenshotCapture -Restart -ZTI
}
#endregion
#=================================================
#region Specialize
